...
int controller_sortEmployee(LinkedList* pArrayListEmployee)
{
	...
	{
	case 1:
		utn_getNumeroInt(&opcionOrdenar,"Elija una opcion de ordenamiento: \n0.Ascendente \n1.Descendente \n","Error. Elija un numero valido",0,1,3);
		if(opcionOrdenar == 0)
		{
		...
		break;
	case 2:
		utn_getNumeroInt(&opcionOrdenar2,"Elija una opcion de ordenamiento: \n0.Ascendente \n1.Descendente \n","Error. Elija un numero valido",0,1,3);
		if(opcionOrdenar2 == 0)
				{
